...
config = {
    'board_size':                  15,    # square box N x N
    ...
    'hidden_activation':     'relu',     # Options are [relu, sigmoid, tanh, linear, leaky_relu]
    # Output layer activation is specific to the output layer 
    'output_activation':     'sigmoid',  # Options are [relu, sigmoid, tanh, linear, leaky_relu]
    # Hidden network architecture describes the number of nodes in each hidden layer
    'hidden_layer_units': {4 : [16, 8], 8: [20, 16, 8], 16: [32, 16, 8]},   # A list containing number of nodes in each hidden layer [20, 12]
